...
exports.TemplateManager = function() {
  ...
  var generateTeardown = function(config) {
    config = config || {};
  ...
  * config.remove = true | false
  *******************************************************************************/

  this.generateTeardown = function(config) {
    return generateTeardown(config);
  };
  ...
  *******************************************************************************/
  this.generateAll = function(config, forced) {
    ...
    fs.write(teardown, this.generateTeardown(config.teardown));
